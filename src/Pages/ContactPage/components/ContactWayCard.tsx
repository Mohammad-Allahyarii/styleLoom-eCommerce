...
const ContactWayCard = ({contactWayInfo}: { contactWayInfo: ContactWayType }) => {
  return <div className="flex flex-col items-center gap-4 p-15 relative">
    ...
    <Button className="w-full" variant="cornerBordered" onClick={contactWayInfo.ctaFunc}>
      {contactWayInfo.info}
    </Button>

    <img className="absolute top-0 right-0" src={contactWayInfo.sideIconAddress} alt={contactWayInfo.title} />
  </div>;
};
