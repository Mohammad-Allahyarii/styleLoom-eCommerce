...
export const FAQS: FAQ_TYPE[] = [
  ...
  },
  {
    ...
    answre: "No, only one discount code can be applied per order. Choose the code that gives you the best value before proceeding to checkout."
  },
  {
    id: 4,
    questionType: "ordering",
    question: "Is there a minimum order value required?",
    answre: "There is no minimum order value. You can place an order for any amount, but free shipping is available for orders above a certain threshold."
  },
  {
    id: 5,
    questionType: "ordering",
    question: "Can I order products that are out of stock?",
    answre: "Unfortunately, we cannot accept orders for out-of-stock items. However, you can sign up for restock notifications to be alerted when they become available."
  },
  {
    id: 6,
    questionType: "ordering",
    question: "Do I need to create an account to place an order?",
    answre: "No, you can checkout as a guest. However, creating an account allows you to track orders, save addresses, and earn rewards faster."
  },
  ...
  // ============ RETURNS (6 items) ============
  {
    ...
    answre: "We accept returns within 30 days of delivery. Items must be unused, in original packaging, and with all tags attached. Sale items are final sale."
  },
  {
    id: 14,
    questionType: "returns",
  ...
  },
  {
    ...
    answre: "Returns are processed within 5-7 business days after we receive your package. You'll receive a confirmation email once your refund is initiated."
  },
  {
    id: 16,
    questionType: "returns",
    question: "Will I receive a full refund for my return?",
    answre: "Yes, you'll receive a full refund for the product price. However, shipping fees are non-refundable unless the return is due to our error."
  },
  {
    id: 17,
    questionType: "returns",
    question: "Can I return a gift item?",
    answre: "Yes, gift items can be returned for store credit. The original purchaser will receive a refund, or you can receive a gift card for the amount."
  },
  {
    id: 18,
    questionType: "returns",
    question: "Do I have to pay for return shipping?",
    answre: "Return shipping costs are the customer's responsibility unless the item is defective or we made an error. We provide a prepaid label for defective items."
  },
  ...
  // ============ SUPPORT (6 items) ============
  {
    ...
    answre: "You can reach our support team via email at support@styleloom.com, live chat on our website, or by phone at 1-800-555-0199. We're available 24/7."
  },
  {
    id: 20,
    questionType: "support",
    question: "What are your support hours?",
    answre: "Our customer support team is available 24 hours a day, 7 days a week. Feel free to reach out anytime via live chat or email for immediate assistance."
  },
  {
    id: 21,
    questionType: "support",
    question: "How quickly do you respond to support tickets?",
    answre: "We aim to respond to all support tickets within 24 hours. Most inquiries are resolved within 2-3 business days depending on complexity."
  },
  {
    id: 22,
    questionType: "support",
    question: "Do you offer phone support?",
    answre: "Yes, we offer phone support during business hours (9 AM - 6 PM EST, Monday to Friday). For after-hours assistance, please use our live chat or email."
  },
  {
    id: 23,
    questionType: "support",
    question: "Can I get support in languages other than English?",
    answre: "Currently, our support team primarily operates in English. However, we can use translation tools to assist you in other languages whenever possible."
  },
  {
    id: 24,
    questionType: "support",
    question: "Where can I find troubleshooting guides?",
    answre: "Visit our Help Center on the website where you'll find detailed troubleshooting guides, video tutorials, and step-by-step instructions for common issues."
  }
]